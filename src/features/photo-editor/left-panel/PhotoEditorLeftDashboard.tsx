...
export default function PhotoEditorLeftDashboard() {
	...
	const { content: watermarkText, position: watermarkPosition } = watermark || {};
	...
	function handleWatermarkPositionChange(newPosition: { top: number; left: number }) {
		dispatch(
			updateCurrentWatermark({
